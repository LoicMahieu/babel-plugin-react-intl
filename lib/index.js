...
exports.default = function (_ref) {
    ...
    function getDescriptorProps(opts) {
        if (opts.additionalDescriptorProps) {
            return new _set2.default([].concat((0, _toConsumableArray3.default)(DESCRIPTOR_PROPS), (0, _toConsumableArray3.default)(opts.additionalDescriptorProps)));
        }
    ...
    function storeMessage(_ref7, path, state) {
        var id = _ref7.id,
            ...
            others = (0, _objectWithoutProperties3.default)(_ref7, ['id', 'description', 'defaultMessage']);
        var file = state.file,
            opts = state.opts;
        ...
        var additional = {};
        if (opts.additionalDescriptorProps) {
            opts.additionalDescriptorProps.map(function (name) {
                additional[name] = others[name];
            });
        }

        messages.set(id, (0, _extends3.default)({ id: id, description: description, defaultMessage: defaultMessage }, additional, loc));
    }
    ...
    return {
        ...
        visitor: {
            JSXOpeningElement: function JSXOpeningElement(path, state) {
                ...
                var descriptorProps = getDescriptorProps(opts);
                ...
                if (referencesImport(name, moduleSourceName, COMPONENT_NAMES)) {
                    ...
                    var descriptor = createMessageDescriptor(descriptorProps, attributes.map(function (attr) {
            ...
            CallExpression: function CallExpression(path, state) {
                ...
                var descriptorProps = getDescriptorProps(state.opts);
                ...
                function processMessageObject(messageObj) {
                    ...
                    var descriptor = createMessageDescriptor(descriptorProps, properties.map(function (prop) {
